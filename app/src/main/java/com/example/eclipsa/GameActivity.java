...
public class GameActivity extends AppCompatActivity {
    ...
    private void showPauseDialog() {
        ...
        // ⚠️ 不再设置 setOnDismissListener，避免因对话框关闭而误恢复游戏
        builder.show();
    }
    ...
    private void showSettingsDialog() {
        ...
        int speedProgress = settingsPrefs.getInt("speed_multiplier", 4);
        ...
        // 设置对话框关闭后，游戏应继续保持暂停状态（用户需通过“继续”按钮恢复）
        builder.show();
    }
    /**
